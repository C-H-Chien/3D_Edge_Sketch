...
//> Inputs:
//   - N:          Number of views
//   - pts:        Correspondences of points in pixels in the form of Eigen::Vector2d and stacked by std::vector structure.
//                 For example: Eigen::Vector2d pt2D( x, y );
//                              std::vector<Eigen::Vector2d> pts.push_back(pt2D);
