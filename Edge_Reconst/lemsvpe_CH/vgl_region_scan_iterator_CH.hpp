...
#ifndef vgl_region_scan_iterator_CH_hpp_
#define vgl_region_scan_iterator_CH_hpp_
//:
// \file
// \author fsm
// \verbatim
...
class vgl_region_scan_iterator_CH
{
 protected:
  inline vgl_region_scan_iterator_CH() = default;
  virtual ~vgl_region_scan_iterator_CH() = default;
 public:
