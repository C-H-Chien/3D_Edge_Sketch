...
for(vidx = 1:3)
    ...
    R_1        = R_g(:,:,VALID_INDX);
    T_1        = T_g(:,VALID_INDX);
    reprojection = Kmatrix * (R_1*[recons_coor2(i,1);recons_coor2(i,2);recons_coor2(i,3)] + T_1);
...
%     T_v3 = R21afterBA * GammaTangent_3D2(:,i);
    ...
    plot(TO_Edges_VALID(i,1), TO_Edges_VALID(i,2), 'rx', 'MarkerSize',2, 'LineWidth', 1);
...
for(vidx = 1:3)
    ...
    Kmatrix    = K;
    invK       = inv(Kmatrix);
    R_abs      = R_g(:,:,VALID_INDX);
    T_abs      = T_g(:,:,VALID_INDX);
...
%     T_abs = (0.99 + (0.02)*rand(1))*T_abs;
    ...
    R_1        = R_abs;
    T_1        = T_abs;
    reprojection = Kmatrix * (R_1*[recons_coor2_pret(i,1);recons_coor2_pret(i,2);recons_coor2_pret(i,3)] + T_1);
