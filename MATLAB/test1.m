...
% load('MATData/paired_edge_44n31_99_noparal.mat')
% load('MATData/wedgepair44n31.mat')
paired_edge=load('MATData/paired_edge_45n42.mat').paired_edge;

% set all the parameters
params.NUM_OF_IMGS              = size(collect_third_order_edges, 1);
params.HYPO1_VIEW_INDX          = 45;
params.HYPO2_VIEW_INDX          = 42;
...
%     edgel_HYPO1 = round(TO_Edges_HYPO1(6253, 1:2));
%     edgel_tgt1  = tgt1(6253, 1:2);
%     edgel_HYPO2 = TO_Edges_HYPO2(5551, 1:2);
%     edgel_tgt2  = tgt2(5551, 1:2);
%     edgel_HYPO1_1 = TO_Edges_HYPO1(6253, 1:2);
    ...
    %> Read Depths
    HYPO1_Depth_dir = strcat(FilePath_Depths, string((params.HYPO1_VIEW_INDX)*19), '.png');
    HYPO2_Depth_dir = strcat(FilePath_Depths, string((params.HYPO2_VIEW_INDX)*19), '.png');
