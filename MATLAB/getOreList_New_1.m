function [ore_p1p2_all, ore_list2_sorted, epipole_pix_view1, epipole_pix_view2]= getOreList_New_1(edgel_HYPO1, edgels_HYPO2, R_matrix, T_matrix, V1IDX, V2IDX, params, K)
...
anglehypo1all             = atan(dxdy_hypo1all(2,1)./dxdy_hypo1all(1,1));
...
p1_all = [p1x_hypo_all(p1_1,1),p1y_hypo_all(p1_1,1), ...
          p1x_hypo_all(p1_2,2),p1y_hypo_all(p1_2,2), ...
          p1x_hypo_all(p1_3,3),p1y_hypo_all(p1_3,3), ...
          p1x_hypo_all(p1_4,4),p1y_hypo_all(p1_4,4)];
...
p2_all = [p2x_hypo_all(p1_1,1),p2y_hypo_all(p1_1,1), ...
          p2x_hypo_all(p1_2,2),p2y_hypo_all(p1_2,2), ...
          p2x_hypo_all(p1_3,3),p2y_hypo_all(p1_3,3), ...
          p2x_hypo_all(p1_4,4),p2y_hypo_all(p1_4,4)];
...
ore_p1p2_4 = [ore_list_p1p, ore_list_p1n, ore_list_p2p, ore_list_p1n];
