...
recons_coor1 = [recons_coor1; Gamma1s_trans'; Gamma1s_trans1'];
fig = 3;
sub = 1;
sbr = 2;
sbc = 5;
...
R21afterBA    = abs_R2afterBA * abs_R1afterBA';
T21afterBA    = abs_R2afterBA * (abs_C1afterBA - abs_C2afterBA);
Gamma1s_trans1_1 = R21afterBA'*(recons_coor1'-T21afterBA);
